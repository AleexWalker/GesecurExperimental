...
class IncidencesViewModel(
    ...
    fun getUserIncidences(date: LocalDate) = launch {
        ...
        when (val result = incidenceRepository.getIncidences(currentUser!!.id)) {
            is Either.Right -> {
    ...
    fun addIncidence(incidence: Incidence, file: File?) = launch {
        ...
        when (val result = incidenceRepository.addIncidence(currentUser!!.id, currentUser!!.id, incidence, file)) {
            is Either.Right -> {
